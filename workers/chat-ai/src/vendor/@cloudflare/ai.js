                ...
                for (let i0 = 0; i0 < len0; i0++) {
                  ...
                  if (errors === _errs12) {
                    if (data4 && typeof data4 == "object" && !Array.isArray(data4)) {
                      let missing2;
                      if (data4.role === void 0 && (missing2 = "role") || data4.content === void 0 && (missing2 = "content")) {
                        const err6 = {
                          instancePath: instancePath + "/messages/" + i0,
                          schemaPath: "#/oneOf/1/properties/messages/items/required",
                          keyword: "required",
                        ...
                        if (data4.role !== void 0) {
                          ...
                          if (typeof data4.role !== "string") {
                            const err7 = {
                              instancePath: instancePath + "/messages/" + i0 + "/role",
                              schemaPath: "#/oneOf/1/properties/messages/items/properties/role/type",
                              keyword: "type",
                              params: { type: "string" },
                              message: "must be string"
                            };
                          ...
                          if (data4.content !== void 0) {
                            ...
                            if (errors === _errs16) {
                              if (typeof data6 === "string") {
                                if (func2(data6) > 4096) {
                                  const err8 = {
                                    instancePath: instancePath + "/messages/" + i0 + "/content",
                                    schemaPath: "#/oneOf/1/properties/messages/items/properties/content/maxLength",
                                    keyword: "maxLength",
                                    params: { limit: 4096 },
                                    message: "must NOT have more than 4096 characters"
                                  };
                                ...
                                const err9 = {
                                  instancePath: instancePath + "/messages/" + i0 + "/content",
                                  schemaPath: "#/oneOf/1/properties/messages/items/properties/content/type",
                                  keyword: "type",
                                  params: { type: "string" },
                                  message: "must be string"
                                };
  ...
  preProcessing() {
    ...
    if (this.inputs.messages === void 0) {
      ...
      if (this.modelSettings.preProcessingArgs.scopedPrompt) {
        ...
        const assistant = this.inputs.messages.map((m) => m.role).indexOf("assistant");
        const systemContent = system > -1 ? this.inputs.messages[system].content : "";
        const userContent = user > -1 ? this.inputs.messages[user].content : "";
        const assistantContent = assistant > -1 ? this.inputs.messages[assistant].content : "";
        prompt = this.modelSettings.preProcessingArgs.scopedPrompt.replace("$system", systemContent).replace("$user", userContent).replace("$assistant", assistantContent);
      }
    }
